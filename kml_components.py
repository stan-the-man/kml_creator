...
<Document>
    ...
    def meter_style():
        ...
        <ListStyle>
            <ItemIcon>
                <href>http://maps.google.com/mapfiles/kml/paddle/M-lv.png</href>
            </ItemIcon>
        </ListStyle>
    </Style>
    <StyleMap id="m_ylw-pushpin">
    ...
    @staticmethod
    def folder_in_folder_start(name):
        return """<Folder>
            <name>%s</name>
            <open>1</open>
            """ % (name)
    ...
    @staticmethod
    def meter_icon(id, lon, lat, service_num, service_addr, water_use):
        return """<Placemark>
                <name>%s</name>
                <description>Service Number: %s
Service Address: %s
Water use: %s
                </description>
                <LookAt>
            ...
            """ % (id, service_num, service_addr, water_use, lon, lat, lon, lat)
